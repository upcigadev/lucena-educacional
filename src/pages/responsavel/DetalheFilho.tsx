...
import { alunos, gerarFrequencia, getJustificativasByResponsavel } from '@/data/mockData';
...
export default function DetalheFilho() {
  ...
  const justificativas = getJustificativasByResponsavel('1').filter(j => j.alunoId === aluno.id);
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">{aluno.escolaNome} — {aluno.turmaName}</p>
        </div>
      </div>
